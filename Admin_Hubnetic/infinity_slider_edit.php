...
$data= editdata('infinity_slider',$id);
...
if(isset($_POST['submit']))
{
  ...
  update($data,'infinity_slider',$id);
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12">
              ...
              <button type="add" name="add" style="float:right;margin-right:50px;color:white;padding:14px 28px;font-weight:700;font-size:14px;" class="btn btn-primary"> <a href="infinity_slider_add.php" style="text-decoration:none;color:white;"> Back</a></button>
            ...
            <form method="post" enctype="multipart/form-data">
              ...
              <label>Image</label>
                ...
                <img src="uploads/Infinity/<?php echo $data['image']; ?>" style="height: 80px;"><br>
