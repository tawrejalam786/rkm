        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12">
              ...
              <button type="back" name="back" style="float:left;margin-right:50px;color:white;padding:14px 28px;font-weight:700;font-size:14px;" class="btn btn-primary"> <a href="Slider.php" style="text-decoration:none;color:white;"> Back</a></button>
