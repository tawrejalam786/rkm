        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12">                    
              ...
              <center><h2 style="padding-bottom:30px;font-weight:900;">Accesorries Edit Page!</h2> </center>      
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter Your Subeading" name="subheading" value="<?php echo $data['subheading']; ?>">
              </div>
              <br>
