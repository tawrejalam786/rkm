        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12">
              ...
              <center><h2 style="padding-bottom:30px;font-weight:900;">Slider</h2> </center>      
        ...
        ?>
              ...
              <tbody>
                <tr>            
                  ...
                  <td><img src="../Admin_Hubnetic/uploads/<?php echo $data['image']; ?>" style="height: 80px;"></td>
                  <td style="word-wrap: break-word;max-width: 160px;white-space: normal!important;"><?php echo $data['url']; ?></td>
                  <td>
                    <a href="Slider_edit.php?editid=<?php echo $data['id']; ?>" onclick="return confirm('Do you want to Edit this data')" class="text-light btn btn-primary">Edit</a>

                    <a href="Slider.php?delid=<?php echo $data['id']; ?>" onclick="return confirm('Do you want to delete this data')" class="text-light btn btn-danger">Delete</a>
                  </td>
                </tr>
              </tbody>
              <?php } ?>
