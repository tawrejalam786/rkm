...
<body>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12">
              ...
              <center><h2 style="padding-bottom:30px;font-weight:900;">Exclusive Collection!</h2> </center>      
    ...
    $select= whiledata("new_collection");
    ...
    ?>
      ...
      <tr>
        <td style="word-wrap: break-word;max-width: 160px;white-space: normal!important;"><?php echo $data['title']; ?></td>
        ...
        <td style="word-wrap: break-word;max-width: 160px;white-space: normal!important;"><?php echo $data['explore_url']; ?></td>
        ...
        <td>
        <a href="collection_edit.php?editid=<?php echo $data['id']; ?>" onclick="return confirm('Do you want to Edit this data')" class="text-light btn btn-primary">Edit</a>

        <a href="collection.php?delid=<?php echo $data['id']; ?>" onclick="return confirm('Do you want to delete this data')" class="text-light btn btn-danger">Delete</a>
        </td>
      </tr>
